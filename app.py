...
def calculate():
    if request.method == "POST":
        ...
        min_weights, max_weights = Calculate_portfolio(tickers)
        min_weigh.append(min_weights)
        max_weigh.append(max_weights)
        ticker.append(tickers)
        
        flash("Portfolio generated successfully!", "info")
        flash( "Your optimal portfolio distribution for minimum risk is: " + min_weights, "info")
        flash( "Your optimal portfolio distribution for maximum return is: " + max_weights, "info")
